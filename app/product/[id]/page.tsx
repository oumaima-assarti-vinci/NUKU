...
const PRODUCT_CONFIG: Record<ProductKey, ProductConfig> = {
  sleep: {
    ...
    emoji: "🌙",
    highlights: [
      { emoji: "🌙", text: "Favorise l'endormissement" },
      { emoji: "💤", text: "Sommeil plus profond" },
      { emoji: "🧘", text: "Apaise le mental le soir" },
      { emoji: "⏰", text: "Régule le rythme veille-sommeil" },
    ],
  ...
  shine: {
    ...
    emoji: "✨",
    highlights: [
      { emoji: "💆", text: "Cheveux plus forts & résistants" },
      { emoji: "✨", text: "Éclat & vitalité de la peau" },
      { emoji: "💅", text: "Ongles renforcés" },
      { emoji: "🌿", text: "Formule naturelle & progressive" },
    ],
  ...
  source: {
    ...
    emoji: "🌿",
    highlights: [
      { emoji: "🌿", text: "Soutient la digestion naturelle" },
      { emoji: "💧", text: "Sensation de légèreté" },
      { emoji: "🌱", text: "Synergie de plantes détox" },
      { emoji: "⚖️", text: "Équilibre digestif au quotidien" },
    ],
  ...
  strength: {
    ...
    emoji: "💪",
    highlights: [
      { emoji: "💪", text: "Performance physique augmentée" },
      { emoji: "⚡", text: "Énergie cellulaire durable" },
      { emoji: "🧠", text: "Clarté mentale & concentration" },
      { emoji: "🔁", text: "Récupération musculaire" },
    ],
  ...
  soul: {
    ...
    emoji: "🕊️",
    highlights: [
      { emoji: "🕊️", text: "Calme intérieur & sérénité" },
      { emoji: "🧘", text: "Meilleure gestion du stress" },
      { emoji: "😊", text: "Équilibre émotionnel" },
      { emoji: "🔋", text: "Réduit la fatigue mentale" },
    ],
